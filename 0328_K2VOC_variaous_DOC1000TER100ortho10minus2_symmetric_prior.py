...
#     zero = p
#     zero_out = zero*10000000
#     os.system ("mkdir " + "K2ND" + str(dn) + "TE" + str(tm) + "VOC" + str(VOC) + "ortho_minus" + str(ortho_count))
#     path = "K2ND" + str(dn) + "TE" + str(tm) + "VOC" + str(VOC) + "ortho_minus" + str(ortho_count)
#     while (a == 0):
#         phi = []
#         for i in range(TOPIC_N):
#             topic = numpy.random.mtrand.dirichlet(beta, size = 1)
...
#                 #print (j)t (k)
#             count_total += int(bb[i+1]) 
#     scipy.io.savemat('observed_word_matrix_DN' + str(dn) + 'NT' + str(tm) + "VOC" + str(VOC) + "ortho_minus" + str(ortho_count) + '.mat', mdict={'matrix': matrix})
...
#                 pro = float(ab[i+1])
#                 phi_matrix[index][j] = pro 
#     scipy.io.savemat('parameter_original_DN' + str(dn) + 'NT' + str(tm) + "VOC" + str(VOC) + "ortho_minus" + str(ortho_count) + '.mat', mdict={'phi_matrix_original': phi_matrix})
